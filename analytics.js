...
Analytics.computeRisk = function({
  ...
  // relies on Engine (already loaded before analytics.js)
  ...
  return {
    ...
    tier,
    topReasons: top,
    debug: { totalToday, intents7, pressure, loop, trend }
  };
};
...
/* =========================================================
   4) LEARNING — Action performance from outcomes
   result: "done" | "partial" | "ignored"
   score range ~ [-2 .. +2]
   ========================================================= */
...
Analytics.actionPerformance = function(events){
  ...
  function score(s){
    ...
    // strict: reward success strongly, penalize ignored strongly
